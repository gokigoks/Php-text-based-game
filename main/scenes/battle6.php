...
<head>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8">
		...
		<style type="text/css">
		    .centerDiv {
		      	background-image: url('../../asset/images/dragonfortress.jpg');
...
<body>
		<div class="centerDiv" >
				...
				<div class = "battle2"><br>
					...
					<img src="../../asset/images/drag2.png" class = "mons">
					<div class = "hp-cont">
					enemy Hp : <?php   
					...
					?>
					</div>nemy Hp : <?php   echo $enemy->getCurrentHp() . '/' .$enemy->getMaxHp();	?>
					...
					<div class = "battle1">
						<div class= "stats-cont"> 
							...
							<a href="battle6.php?move=flee"><div class = "flee">Flee</div></a>
							<?php } 
							else {
